...
def get_keys():
	...
	max_keys_in_a_row = 11						
	key_width = int(width/max_keys_in_a_row)	
	
	row0_key_width = key_width * 11			
	row1_key_width = key_width * 10			
	row2_key_width = key_width * 9			
	row3_key_width = key_width * 7			
	row4_key_width = key_width * 5			
	row_keys = []							

	# for the zeroth row
	x1, y1 = 0, int((height - key_width * 5) / 2)	# 5 is due to the fact that we will have 5 rows.
                                                        #y1 is set such that the whole keyboard has equal margin on both top and bottom
